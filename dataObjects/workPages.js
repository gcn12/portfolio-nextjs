export const workPages = {
  voyager: {
    ...
    mainImage:
      "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/travel%2Ftravel2.png?alt=media&token=a6edda5b-c440-4fe7-b9f4-511b2e1ca3a4",
    ...
    content: [
      ...
      },
      {
        ...
        header: "Page layout",
        paragraph:
          "Each post displays the title, location, along with user-written paragraphs and photos. To further personalize posts, users can choose from a variety of fonts. After reading an article, users can give it a heart, save it to read later, or add it to a collection. At the bottom of each post, suggested articles are provided for further reading.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/travel%2Ftravel_full_2.png?alt=media&token=69775d39-6c0b-447f-bdb1-5c8d22796d93",
      },
      {
        type: "photoDescriptionLeft",
        header: "Save posts",
        paragraph:
          "If a user finds a post they are particularly drawn to, they can add it to a collection or save it to read later.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/travel%2Ftravel_add_to_collection_save.png?alt=media&token=9bd1e416-b1c5-4deb-83c0-6de7071e0430",
      },
      {
        type: "photoDescriptionRight",
        header: "Full-text search",
        paragraph:
          "Integration with Algolia enables searching through places, posts, and other travelers. Search results are updated for every post uploaded and for every user who signs up.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/travel%2Ftravel_full_search.png?alt=media&token=0cbd752b-bfe5-49f6-89b4-00c5cb0f834e",
      },
      {
        type: "section",
        header: "Future improvements and key takeaways",
        paragraph:
          "The largest flaw is the lack of accessibility. There are several areas a keyboard-only user may not be able to use. Accessibility is something that I began learning about near the end of the project, so moving forward, creating accessible apps will be a priority. \n \n Another improvement could be the overall architecture of the program, in both the front-end and back-end. The original idea for the app was much simpler, but then grew to include more features, many of which interconnected. In creating a larger project, the code became more complex and less organized. In future projects, careful planning will provide a solid app structure and ensure a higher quality of code.",
      },
      {
        type: "photo",
  ...
  cubeclock: {
    ...
    mainImage:
      "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/timer%2Ftimer%202.png?alt=media&token=9c1fc278-d076-41fd-9330-41ab89d5ebaf",
    ...
    content: [
      ...
      },
      {
        ...
        paragraph:
          "A highly requested feature was the ability to use any World Cube Association puzzle. Puzzles have unique mechanics, therefore requiring different scrambling algorithms. Users can select a puzzle of their choice, which allows CubeClock to deliver analytics and to preserve specific solve data.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/timer%2Ftimer_puzzles_list.png?alt=media&token=900143b9-b7e5-4e46-a4c9-67aaceef86ad",
      },
      {
        type: "photoDescriptionRight",
        header: "User preferences",
        paragraph:
          "CubeClock allows users to customize the app to their tastes. Options include inspection times, the ability to display averages, and various ways of inputting their solve times. \n \n Many puzzle enthusiasts already have their data saved elsewhere. CubeClock makes it effortless to import and export data.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/timer%2Ftimer_preferences.png?alt=media&token=8bad09aa-2a4f-4145-b4c9-04e544c7a890",
      },
      {
        type: "photoDescriptionLeft",
        header: "Save every session",
        paragraph:
          "Users can create unlimited sessions--a way of categorizing multiple solves by puzzle and date. Sessions can always be returned to, allowing a solver to pick up where they left off.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/timer%2Ftimer_sessions.png?alt=media&token=fa221d3d-282f-462a-aebb-414f0c599faa",
      },
      {
        type: "photoDescriptionRight",
        header: "Track progress",
        paragraph:
          "Collected and stored data is presented in the form of charts. Solvers can visualize trends in their times and their solve frequency. To provide more specific results, charts can be sorted by puzzle type and date.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/timer%2Ftimer_analytics.png?alt=media&token=57887378-9c46-4794-b231-e3949fb782a3",
      },
      {
        type: "section",
        header: "Future improvements and key takeaways",
        paragraph:
          "Looking back on this project, there are few improvements that can be made. This was my first real development project and was created when I only had a month or two of experience. The largest inefficiency is that data is stored in a single PostgreSQL row. As a result, all of the user's data must be downloaded at login and reuploaded after every solve. This can slow down the start times of the app and also causes unnecessary data transfers. \n \n Another issue is that all session data, such as averages, are recalculated when a user visits the dashboard. This is problematic because a user may only need to see a select few sessions, rather than all of them. The calculations being run are also intensive on the JS engine since there are a number of nested loops. \n \n The design of the app also leaves something to be desired, as the white and black color combination provides little depth to the interface. In the future, the layout and color schemes could be improved upon to deliver a satisfying user experience.",
      },
    ],
  },
  cinematography: {
    ...
    mainImage:
      "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/cine%2Fcine.png?alt=media&token=d11bf406-bd28-4fe5-8b91-c2fae3bfee19",
    ...
    content: [
      {
        ...
        header: "Project overview",
        paragraph:
          "This project was a static website to showcase my cinematography work. It needed to play videos from Vimeo and YouTube, and display each project individually. Stylistically, the site needed to be clean and minimalistic to keep the focus on the work itself.",
      },
      {
        type: "createdWith",
        header: "Created with these technologies",
      ...
      },
      {
        ...
        paragraph:
          "Each piece of work contains a title, video, and an assortment of still images from the project. Videos can be embedded from YouTube or Vimeo while maintaining their aspect ratio. Custom video thumbnails are used to enhance the presentation.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/cine%2Fcinematography_full_page.png?alt=media&token=53be8fc5-c855-4845-b23a-7305e266c17c",
      },
      {
        type: "photoDescriptionLeft",
        header: "Work page",
        paragraph:
          "Projects are displayed as thumbnails in a grid. When hovered, visitors can see the project name. On mobile devices, project names are displayed by default.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/cine%2Fcinematography_work_desktop.png?alt=media&token=cd30fa6b-5846-4e91-8a11-57f6884714ae",
      },
      {
        type: "photoDescriptionRight",
        header: "Stills gallery",
        paragraph:
          "Images from the project pages can be enlarged and viewed through a gallery. When hovered, the image provides arrows to navigate through photos. If preferred, the keyboard arrow keys can also be used.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/cine%2Fcinematography_still_gallery.png?alt=media&token=0c55d854-26bb-4b00-819e-2fd59ea29d80",
      },
      {
        type: "photoDescriptionLeft",
        header: "Home page",
        paragraph:
          "Visitors to the site are immediately presented with a cinematography highlight reel. A custom play button and thumbnail are displayed on top of an embedded Vimeo video.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/cine%2Fcinematography_homepage.png?alt=media&token=db0f819c-b4f9-45e6-966c-ea74b27d294b",
      },
      {
        type: "section",
        header: "Future improvements and key takeaways",
        paragraph:
          "In the original version of this site, a lot of CSS styling was overcomplicated and sometimes unnecessary. Other styles that were not set correctly, such as grids resulted in mismatched margins. In a recent refactor, these improvements have been made. \n \n Redux is something that could likely be removed as all state management requirements can be handled by React itself. Although Redux was used to make the code cleaner, in this case its inclusion has made the project more complicated.",
      },
    ],
  },
  redraft: {
    ...
    mainImage:
      "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/redraft%2Fscene1-2.png?alt=media&token=969fe487-d388-4442-8add-9b8459459f1e",
    ...
    content: [
      {
        ...
        header: "Project overview",
        paragraph:
          "Redraft is an app that gives screenwriters the tools they need to deliver their best work. The What You See Is What You Get (WYSIWYG) text editor provides a representation of the final result. When the writing is complete, screenplays can be exported as a PDF with industry-standard formatting.  \n \n In addition to screenplays, writers can create notes to store research and outlines to plan their stories. \n \n Redraft was created to be accessible to as many users as possible, allowing for both keyboard and screen-reader use.",
      },
      {
        type: "createdWith",
        header: "Created with these technologies",
      ...
      },
      {
        ...
        paragraph:
          "Redraft formats while writers type, allowing them to solely focus on their work. Additionally, the editor provides autocomplete for locations and character names.",
      },
      {
        ...
        paragraph:
          "Virtual notecards allow writers to effortlessly plan their stories. Each card can be moved by dragging and dropping, or with a keyboard.",
      },
      {
        type: "photoDescriptionLeft",
        header: "Multiple file types",
        paragraph:
          "Redraft uses a folder structure to keep files organized. Within folders, users can create a screenplay, notes, or an outline.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/redraft%2FScreen%20Shot%202021-05-01%20at%2010.02.50%20AM.png?alt=media&token=f9926740-3f3e-4efe-a4d6-a0716c45d9f4",
      },
      {
        type: "photoDescriptionRight",
        header: "Daily writing goals",
        paragraph:
          "Writers can stay on schedule by defining a writing goal. Progress is displayed on the dashboard for quick access and resets at midnight every day.",
        photoLink:
          "https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/redraft%2FScreen%20Shot%202021-05-01%20at%209.10.38%20AM.png?alt=media&token=a636dfc0-2025-46dd-8c46-1abc27a05900",
      },
      {
        type: "videoDescriptionLeft",
