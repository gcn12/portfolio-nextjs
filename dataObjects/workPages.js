        ...
        content: [
            {
                ...
                paragraph: 'The Travel Blogger app allows anyone to write about their vacations. Users can also plan future trips by searching by location and category.', 
            },
            {
                type: 'createdWith',
                header: 'Created with',
                items: ['React.js', 'Firebase', 'Algoia Search', 'Framer Motion', 'React-Router', 'Redux', 'Styled Components', 'Google Places API'],
            },
            {
                type: 'section',
            ...
            },
            {
                ...
                paragraph: 'With Algoia integration, users can search for places, posts, and other users.', 
                photoLink: '../travel_full_text_search.png',
            },
            {
                type: 'section',
                header: 'Future improvements',
                paragraph: 'This app does not satisfy all accessibility requirements. Additionally, the code could be written to be more performant and more DRY', 
            },
            {
                type: 'section',
    ...
    timer: {
        ...
        content: [
            ...
            },
            {
                type: 'createdWith',
                header: 'Created with',
                items: ['React.js', 'Postgres', 'Express', 'Chart.js', 'Grid.js', 'Moment.js'],
            },
            {
                type: 'photo',
                link: '../timer_2.png',
