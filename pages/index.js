...
import { Container, LatestProjects } from "../styles/index.styles";
...
const Home = (props) => {
  ...
  return (
    <Container style={{ minHeight: "85vh" }}>
      ...
      <LandingPage
        setHomeButtonScaled={props.setHomeButtonScaled}
        homeButtonScaled={props.homeButtonScaled}
        viewedHome={props.viewedHome}
        setViewedHome={props.setViewedHome}
      />
