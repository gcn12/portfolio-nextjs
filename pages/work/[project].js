...
const Project = (props) => {
	...
	useEffect(() => {
		...
		if (
			(!props.viewedTimer ||
				!props.viewedCinematography ||
				!props.viewedTravel ||
				!props.viewedMessaging) &&
			project
		) {
		...
		<div>
			...
			{pageData && (
				<Container>
					...
					<Description hasPageBeenViewed={hasPageBeenViewed}>
								...
								<div style={{ width: "100%" }} key={index}>
									...
									{content.type === "photoDescriptionLeft" && (
										<PhotoDescriptionContainer justify="end">
											<div>
												...
												<Gap />
												<div>
													<PhotoDescriptionParagraph size="large">
														{content.paragraph}
													</PhotoDescriptionParagraph>
												</div>
											</div>
											<PhotoDescriptionImage src={content.photoLink} />
											<PhotoDescriptionParagraph size="small">
												{content.paragraph}
											</PhotoDescriptionParagraph>
										</PhotoDescriptionContainer>
									)}
									{content.type === "photoDescriptionRight" && (
										<PhotoDescriptionContainer justify="start">
											<PhotoDescriptionHeader size="small">
												{content.header}
											</PhotoDescriptionHeader>
											<PhotoDescriptionImage alt="" src={content.photoLink} />
											<div>
												<PhotoDescriptionHeader size="large">
													{content.header}
												</PhotoDescriptionHeader>
												<Gap2 />
												<div>
