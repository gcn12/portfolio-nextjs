    ...
    return(
        <Container isModalVisible={props.isModalVisible}  isModalOpen={props.isModalOpen}>
            ...
            <Nav isModalVisible={props.isModalVisible} isModalOpen={props.isModalOpen}>
                ...
                <NavItem target='_blank' href='https://firebasestorage.googleapis.com/v0/b/portfolio-assets.appspot.com/o/Resume-front-end.pdf?alt=media&token=1ca4c599-7a38-4947-830a-b76e6b2921e0' rel='nonreferrer noopener' onClick={props.closeMenu} underline='0px'>resume</NavItem>
